...
def top_p_sampling_with_temperature(logits, top_p, temperature=1.0):
    ...
    top_p_logits = top_p_logits / (temperature + 1e-10)
...
def top_p_sampling(model, tokenizer, device, prompt, max_new_tokens, top_p=0.9, temperature=1.0):
